...
const countriesData = ref<Country[]>([...countries.rows])
const departmentsData = ref<Department[]>([...departments.rows])
const provincesData = ref<Province[]>([...provinces.rows])
const districtsData = ref<District[]>([...districts.rows])
